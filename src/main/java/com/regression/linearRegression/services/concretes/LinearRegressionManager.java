...
public class LinearRegressionManager implements LinearRegressionService {
    ...
    private LinearRegressionResult computeCoefficients(double[] xValues, double[] yValues, String xVariableName, String yVariableName) {
    ...
    public LinearRegressionResult calculate(double[] xValues, double[] yValues, String xVariableName, String yVariableName) {
        return computeCoefficients(xValues, yValues, xVariableName, yVariableName);
    }
}
